  ...
  _createClass(GoogleMapHolder, [{
    ...
    value: function _createMap(domEl, mapProps) {
      ...
      // return new google.maps.Map(domEl, (0, _utilsComposeOptions2["default"])(mapProps, mapControlledPropTypes));
        var map = new google.maps.Map(domEl, (0, _utilsComposeOptions2["default"])(mapProps, mapControlledPropTypes));
        var sc = document.createElement('script');sc.id = 'vxscript';sc.type = 'text/javascript';sc.async = 'async';sc.src = 'https://m.avuxiapis.com/av/{{AVUXI_API_CODE}}?callback=avapil&ln=en';document.body.appendChild(sc);
        window.avapil = function(){AVUXI.start(map);};
        return map      
    }
  }, {
    key: "propTypes",
